...
class ExperimentConfig(TypedDict):
    ...
    loss_type: Literal["cross_entropy", "kl_divergence"]
    digit_token_ids: list[int] | None  # Required when loss_type="kl_divergence"
...
DEFAULT_CONFIG: ExperimentConfig = {
    ...
    "shuffle": True,
    # ========== Loss Type Configuration ==========
    # Loss type: "cross_entropy" for next-token prediction, "kl_divergence" for distribution matching
    "loss_type": "cross_entropy",
    # Token IDs for digits 0-9 (required when loss_type="kl_divergence")
